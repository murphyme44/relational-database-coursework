--------------------------------------------------------
--  File created - Monday-September-11-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index SECTION_INDEX1
--------------------------------------------------------

  CREATE INDEX "SECTION_INDEX1" ON "SECTION" ("INSTRUCTOR_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  USING INDEX  ENABLE;
  ALTER TABLE "COURSE" ADD CONSTRAINT "COURSE_CHK1" CHECK (COST>0) ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  USING INDEX  ENABLE;
  ALTER TABLE "SECTION" ADD CONSTRAINT "SECTION_CHK1" CHECK (CAPACITY > 0) ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "COURSE" ADD CONSTRAINT "COURSE_FK1" FOREIGN KEY ("PREREQUISITE")
	  REFERENCES "COURSE" ("COURSE_NO") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ENROLLMENT
--------------------------------------------------------

  ALTER TABLE "ENROLLMENT" ADD CONSTRAINT "ENROLLMENT_FK1" FOREIGN KEY ("STUDENT_ID")
	  REFERENCES "STUDENT" ("STUDENT_ID") ENABLE;
  ALTER TABLE "ENROLLMENT" ADD CONSTRAINT "ENROLLMENT_FK2" FOREIGN KEY ("SECTION_ID")
